...
export const ProductDetails = () => {
  ...
  const { trackPurchase } = useUserBehavior(id);
  ...
  const handleAddToCart = async (quantity) => {
    // Track purchase behavior when adding to cart
    await trackPurchase(quantity);
  };
            ...
            <>
              <div className="container flex gap-8 flex-col lg:flex-row items-start lg:items-center">
                ...
                <div className="productContent w-full lg:w-[60%] pr-2 pl-2 lg:pr-10 lg:pl-10">
                  <ProductDetailsComponent item={productData} reviewsCount={reviewsCount} gotoReviews={gotoReviews} onAddToCart={handleAddToCart} />
                </div>
              </div>
